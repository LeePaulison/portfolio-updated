...
export const ProjectsTeaser = async () => {
  ...
  return (
    <section id='projects' className="bg-muted/40 py-16  border-t border-x border-border/60">
      <h2 className="text-3xl font-extrabold text-primary mb-10 text-center">Projects</h2>
